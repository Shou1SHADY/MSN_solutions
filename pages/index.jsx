  ...
  return (
    <div className="bg-primary/60 min-h-screen relative">
      ...
      <div className="w-full min-h-screen bg-gradient-to-r from-primary/10 via-black/30 to-black/10">
        <div className="text-center flex flex-col justify-center pt-28 md:pt-32 xl:pt-40 xl:text-left h-full container mx-auto">
          {/* title */}
          <motion.h1
            variants={fadeIn("down", 0.2)}
            initial="hidden"
      ...
      <div className="w-[1280px] h-full absolute right-0 bottom-0">
        ...
        <motion.div
          ...
          exit="hidden"
          transition={{ duration: 1, ease: "easeInOut" }}
          className="w-full h-full max-w-[637px] max-h-[578px] absolute bottom-0 lg:bottom-0 lg:right-[8%] z-10"
        >
          <Avatar />
        </motion.div>
      </div>
